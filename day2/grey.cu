/*
Brutally copied from https
://github.com/junstar92/parallel_programming_study/blob/master/CUDA/imageProcessing/convertColorToGrey.cu
Thank you Junstar92!
...
*Compile : nvcc -o grey grey.cu -I.. -lcuda $(pkg-config opencv4 --libs
--cflags)
...
__global__ void colorToGreyscaleConversion(unsigned char* in,
...
int main(int argc, char** argv) {
  ...
  cudaMemcpy(d_origImg, h_origImg,
             width * height * channels * sizeof(unsigned char),
  ...
  colorToGreyscaleConversion<<<grid, threads>>>(d_origImg, d_resultImg, width,
                                                height);
